...
import com.evan.greennote.comment.biz.constant.RedisKeyConstants;
import com.evan.greennote.comment.biz.domain.dataobject.CommentDO;
import com.evan.greennote.comment.biz.domain.dataobject.CommentLikeDO;
import com.evan.greennote.comment.biz.domain.mapper.CommentDOMapper;
import com.evan.greennote.comment.biz.domain.mapper.CommentLikeDOMapper;
import com.evan.greennote.comment.biz.domain.mapper.NoteCountDOMapper;
import com.evan.greennote.comment.biz.enums.*;
import com.evan.greennote.comment.biz.model.dto.LikeUnlikeCommentMqDTO;
...
import com.evan.greennote.comment.biz.rpc.DistributedIdGeneratorRpcService;
import com.evan.greennote.comment.biz.rpc.KeyValueRpcService;
import com.evan.greennote.comment.biz.rpc.UserRpcService;
...
public class CommentServiceImpl implements CommentService {
    ...
    public Response<?> publishComment(PublishCommentReqVO publishCommentReqVO) {
        ...
        Preconditions.checkArgument(
                !StringUtils.isBlank(content) || !StringUtils.isBlank(imageUrl),
                "评论正文和图片不能同时为空"
        );
