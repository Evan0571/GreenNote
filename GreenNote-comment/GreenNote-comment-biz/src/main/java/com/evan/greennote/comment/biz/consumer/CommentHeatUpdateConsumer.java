...
import com.evan.greennote.comment.biz.model.bo.CommentHeatBO;
import com.evan.greennote.comment.biz.util.HeatCalculator;
...
//评论热度值计算
@Component
@RocketMQMessageListener(consumerGroup = "greennote_group_" + MQConstants.TOPIC_COMMENT_HEAT_UPDATE, // Group 组
