package com.evan.greennote.comment.biz.consumer;
...
import com.evan.greennote.comment.biz.enums.CommentLevelEnum;
...
@Component
@Slf4j
@RocketMQMessageListener(consumerGroup = "greennote_group_" + MQConstants.TOPIC_DELETE_COMMENT, // Group
...
public class DeleteCommentConsumer implements RocketMQListener<String> {
    ...
    private void handleTwoLevelComment(CommentDO commentDO) {
        ...
        // DB 扣减：更新一级评论的子评论总数（包含当前删除的这条二级评论本身）
        commentDOMapper.decreaseChildCommentTotal(parentCommentId, count + 1);
