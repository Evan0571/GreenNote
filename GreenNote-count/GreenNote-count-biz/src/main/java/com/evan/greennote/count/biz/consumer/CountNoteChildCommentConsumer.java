...
import com.evan.greennote.count.biz.enums.CommentLevelEnum;
...
//计数: 笔记二级评论数
@Component
@RocketMQMessageListener(consumerGroup = "greennote_group_child_comment_total" + MQConstants.TOPIC_COUNT_NOTE_COMMENT, // Group 组
