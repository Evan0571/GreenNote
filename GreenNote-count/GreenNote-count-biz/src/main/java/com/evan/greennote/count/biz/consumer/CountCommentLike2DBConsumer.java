...
import com.evan.greennote.count.biz.domain.mapper.CommentDOMapper;
...
//计数: 评论点赞数落库
@Component
@RocketMQMessageListener(consumerGroup = "greennote_group_" + MQConstants.TOPIC_COUNT_COMMENT_LIKE_2_DB, // Group 组
