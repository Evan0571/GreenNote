package com.evan.greennote.count.biz.service.impl;
...
public class NoteCountServiceImpl implements NoteCountService {
    ...
    //批量查询笔记计数
    @Override
    public Response<List<FindNoteCountsByIdRspDTO>> findNotesCountData(FindNoteCountsByIdReqDTO findNoteCountsByIdsReqDTO) {
// 需要查询的笔记 ID 集合
