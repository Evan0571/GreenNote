...
import com.evan.greennote.count.biz.enums.LikeUnlikeCommentTypeEnum;
import com.evan.greennote.count.biz.model.dto.AggregationCountLikeUnlikeCommentMqDTO;
import com.evan.greennote.count.biz.model.dto.CountLikeUnlikeCommentMqDTO;
...
//计数: 评论点赞数
@Component
@RocketMQMessageListener(consumerGroup = "greennote_group_count_" + MQConstants.TOPIC_COMMENT_LIKE_OR_UNLIKE, // Group 组
