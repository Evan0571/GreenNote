...
import com.evan.greennote.data.align.model.dto.FollowUnfollowMqDTO;
...
// 日增量数据库：用户关注数
@Component
@RocketMQMessageListener(consumerGroup = "greennote_group_data_align_" + MQConstants.TOPIC_COUNT_FOLLOWING,
...
public class TodayUserFollowIncrementData2DBConsumer implements RocketMQListener<String> {
    ...
    public void onMessage(String body) {
        log.info("## TodayUserFollowIncrementData2DBConsumer 消费到了MQ: {}", body);
        // 消息体 JSON 字符串转 DTO
