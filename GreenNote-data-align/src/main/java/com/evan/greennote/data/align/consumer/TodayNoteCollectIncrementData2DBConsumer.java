...
import com.evan.greennote.data.align.model.dto.CollectUnCollectNoteMqDTO;
...
//日增量数据落库：笔记收藏/取消收藏
@Component
@RocketMQMessageListener(consumerGroup = "greennote_group_data_align_" + MQConstants.TOPIC_COUNT_NOTE_COLLECT,
