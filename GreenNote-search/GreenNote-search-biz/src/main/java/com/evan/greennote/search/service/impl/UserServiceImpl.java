...
public class UserServiceImpl implements UserService {
    ...
    public PageResponse<SearchUserRspVO> searchUser(SearchUserReqVO searchUserReqVO) {
        ...
        // 构建 multi_match 查询，查询 nickname 和 greennote_id 字段
        sourceBuilder.query(QueryBuilders.multiMatchQuery(
                keyword, UserIndex.FIELD_USER_NICKNAME, UserIndex.FIELD_USER_GREENNOTE_ID));
        // 排序，按 fans_total 降序
        ...
        try {
            ...
            for (SearchHit hit : hits) {
                ...
                String greennoteId = (String) sourceAsMap.get(UserIndex.FIELD_USER_GREENNOTE_ID);
