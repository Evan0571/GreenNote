    ...
    public PageResponse<SearchNoteRspVO> searchNote(SearchNoteReqVO searchNoteReqVO) {
        ...
        try {
            ...
            for (SearchHit hit : hits) {
                ...
                // 提取特定字段值
                Object idObj = sourceAsMap.get(NoteIndex.FIELD_NOTE_ID);
                Long noteId = idObj == null ? null : ((Number) idObj).longValue();
                ...
                Object likeObj = sourceAsMap.get(NoteIndex.FIELD_NOTE_LIKE_TOTAL);
                Long likeTotal = likeObj == null ? 0L : ((Number) likeObj).longValue();
